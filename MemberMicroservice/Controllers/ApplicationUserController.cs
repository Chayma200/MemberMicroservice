...
namespace MemberMicroservice.Controllers
{
    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        {
            string userId = User.Claims.FirstOrDefault(c => c.Type == "UserID").Value;
            IQueryable<string> comopanyName = _context.ApplicationUsers.Where(r => r.Id == userId).Select(r => r.Company_Name);
            return comopanyName.First();
        }
        [HttpGet]
        [Route("GetUserName")]
        ...
        {
            string userId = User.Claims.FirstOrDefault(c => c.Type == "UserID").Value;
            IQueryable<string> userName = _context.ApplicationUsers.Where(r => r.Id == userId).Select(r => r.UserName);
        ...
        {
            String userName = _context.ApplicationUsers.FirstOrDefault(r => r.Id == userID).UserName;
            return userName;
        }
